...
import 'package:dairyB2b_management/app/features/adjustment/providers/products_manager_provider.dart';
import 'package:dairyB2b_management/app/features/adjustment/ui/widgets/product_card.dart';
...
class ProductList extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    if ((initBrand?.doesNotHaveValue ?? true) &&
        (initCategory?.doesNotHaveValue ?? true)) {
      return Center(
        child: Text(
          'Loading...',
