...
import 'package:dairyB2b_orders/router/shell_router.dart';
import 'package:dairyB2b_orders/router/app_route_paths.dart';
import 'package:dairyB2b_orders/router/scaffold_with_nav_bar.dart';
import 'package:dairyB2b_orders/app/features/kyc/ui/kyc_screen.dart';
  ...
  static final router = GoRouter(
    ...
    routes: <RouteBase>[
      GoRoute(
        ...
        builder: (context, state) => SplashScreen(logo: sysImages.MOlogo),
      ),
      // KnowYourColors
      GoRoute(
        path: AppRoute.knowYourColors.path,
        name: AppRoute.knowYourColors.name,
        builder: (context, state) => KnowYourColors(),
      ),
      GoRoute(
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return PhoneInputScreen(onCodeSent: args.onCodeSent);
        },
      ),
      GoRoute(
