...
/// @nodoc
mixin _$Category {
  String get id; // e.g. 'c456'
  String get label; // e.g. 'Milk Products'
  String? get image;
  ...
  @override
  String toString() {
    return 'Category(id: $id, label: $label, image: $image)';
  }
}
...
class _Category implements Category {
  _Category({required this.id, required this.label, this.image});
